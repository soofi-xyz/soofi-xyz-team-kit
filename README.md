...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/720.png" alt="Hoopa" width="96"> | [`hoopa`](./agents/hoopa.md) | Portal delivery orchestrator — builds a new repo with frontend, Lambda backend, and Amplify preview from a Figma file, other design input, or existing portal. | `/hoopa Build a portal from this Figma, design, or existing site...` |
