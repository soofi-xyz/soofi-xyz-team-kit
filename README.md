...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/065.png" alt="Alakazam" width="96"> | [`alakazam`](./agents/alakazam.md) | RAG architecture specialist — system-agnostic retrieval design for knowledge grounding, prior-decision reuse, semantic mapping, confidence thresholds, and local/cloud/SaaS provider selection. | `/alakazam Design RAG for...` |
...
| [`build-rag-systems`](./skills/build-rag-systems/) | Design system-agnostic RAG systems for knowledge retrieval, prior-decision reuse, semantic mapping, classification, confidence thresholds, and local/cloud/SaaS provider selection. |
...
│   ├── build-rag-systems/           # System-agnostic RAG architecture, retrieval, confidence, and evaluation
