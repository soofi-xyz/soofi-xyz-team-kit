...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/279.png" alt="Pelipper" width="96"> | [`pelipper`](./agents/pelipper.md) | Asana-native dataset export agent — turns board-scoped requests into company-scoped standard debt CSV exports backed by so-persist, with Agency Name resolution, export workflow validation, private S3 links, and status checks. | `/pelipper Export standard company debt CSV...` |
