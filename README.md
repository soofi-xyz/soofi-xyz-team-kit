...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/561.png" alt="Sigilyph" width="96"> | [`sigilyph`](./agents/sigilyph.md) | Report certification specialist — verifies report provenance, definitions, freshness, reproducibility, security, and presentation before sharing, publishing, delivery, or catalog registration. | `/sigilyph Certify this report...` |
