...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/199.png" alt="Slowking" width="96"> | [`slowking`](./agents/slowking.md) | Chief of Staff system builder — defines the Cursor-facing Chief of Staff agent, its backend boundary, its runtime contract, and can drive backend scaffolding in a target repo without collapsing the v1 boundary. | `/slowking Define the Chief of Staff system...` |
...
| [`build-chief-of-staff-runtime`](./skills/build-chief-of-staff-runtime/) | Build the deployed Chief of Staff backend in a target application repo while preserving the approved runtime boundary, dependency gates, auth model, and validation checklist. |
...
| [`build-chief-of-staff-system`](./skills/build-chief-of-staff-system/) | Build the Chief of Staff system definition — lock Cursor-vs-backend ownership, runtime contract rules, platform dependencies, and downstream implementation constraints. |
