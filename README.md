...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/163.png" alt="Hoothoot" width="96"> | [`hoothoot`](./agents/hoothoot.md) | Reporting app builder — secure static HTML reports backed by Persist datasets, scheduled AWS refresh pipelines, shared Cognito Microsoft Azure SSO access, and Amplify deployments. | `/hoothoot Build a report. List widgets first.`<br>[Guide](./docs/hoothoot.md) |
