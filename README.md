...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/113.png" alt="Chansey" width="96"> | [`chansey`](./agents/chansey.md) | Release babysitter — monitors the main agent's PR changes, keeps review/CI/release status moving, and reports explicit error/reason details when something needs to be fixed. | `/chansey Watch this PR through release...` |
