...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/778.png" alt="Mimikyu" width="96"> | [`mimikyu`](./agents/mimikyu.md) | Design-taste specialist — learns the studio designer's taste from a V1 → final Figma evolution (learn mode) and applies it to elevate draft designs non-destructively (apply mode). Named for the Disguise Pokémon, which mimics another's appearance. | `/mimikyu Elevate this draft design...` |
...
| Skill | Description |
| --- | --- |
| [`apply-design-taste`](./skills/apply-design-taste/) | Transform an initial or AI-generated Figma design into a polished, art-directed final by applying the studio designer's learned taste — direction rules derived per-file, never prescribed values. |
...
| [`use-figma-mcp`](./skills/use-figma-mcp/) | User guide for reading and writing Figma files through the official Figma MCP server — tool selection, the `use_figma` execution model, Plugin API mutation rules, and error recovery. |
