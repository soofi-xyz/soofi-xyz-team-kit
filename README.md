...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/065.png" alt="Alakazam" width="96"> | [`alakazam`](./agents/alakazam.md) | RAG agent builder — directs reusable AWS RAG agents with Bedrock, OpenSearch, DynamoDB, S3, and local fixture emulation. | `/alakazam Build RAG for...` |
...
| [`build-rag-systems`](./skills/build-rag-systems/) | Build reusable AWS RAG agents with Bedrock embeddings, OpenSearch retrieval, DynamoDB review state, S3 corpora, and local fixture emulation. |
