...
| [`candidate-agent-qc-validation`](./skills/candidate-agent-qc-validation/) | Evaluate hiring-candidate-built agents against a user story, acceptance criteria, requirements repo, candidate repo, required integrations, integration tests, and user acceptance outcomes, including human-assisted integration auth/setup UX evaluation and hiring decision support. |
