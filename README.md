...
| Skill | Description |
| --- | --- |
| [`apply-engineering-guidelines`](./skills/apply-engineering-guidelines/) | Apply the Golden Path engineering standards for tech stack, infrastructure, testing, observability, mandatory PagerDuty alerting on critical failures, transaction boundary exits, and AI implementation choices. |
...
| [`build-batch-workflows`](./skills/build-batch-workflows/) | Design and implement AWS batch workflows with Step Functions Distributed Map, Glue PySpark, cost gates, throttling, idempotency, transaction boundary exits, staged test pipelines, and mandatory PagerDuty alerting on critical failures. |
