...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/480.png" alt="Uxie" width="96"> | [`uxie`](./agents/uxie.md) | Elephant open-data query agent — answers questions about published county property and geo data by calling the `@elephant-xyz/mcp` MCP server (IPFS via IPNS), read-only. The consumer counterpart to `oracle` (which ingests). Permit/contractor/company indexes to come. | `/uxie What properties are near <lat,lng>...` |
