...
- [Two-week product and agent ramp](./docs/two-week-product-agent-ramp.md) — a 10-day onboarding plan for junior resources learning SOCAPITAL software architecture, AWS basics, product patterns, and agent readiness.
- [Using Hoothoot](./docs/hoothoot.md) — guidance for prod-first Persist reporting through the Hoothoot agent.
...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/016.png" alt="Pidgey" width="96"> | [`pidgey`](./agents/pidgey.md) | Onboarding coach for the two-week product and agent ramp — guides junior engineers through repo navigation, AWS/product basics, Lexicon/Persist/Neptune lessons, exercises, reviews, and quizzes without doing the work for them. | `/pidgey Give me Day 1 training` |
