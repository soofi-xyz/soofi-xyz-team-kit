...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/052.png" alt="Meowth" width="96"> | [`meowth`](./agents/meowth.md) | Cursor spend-operations specialist — owns `agent-meowth`, including PII-free daily aggregate usage/spend delivery to Google Chat and the Step Functions + Asana human-approval workflow for per-user spend-limit increases. | `/meowth Add daily Cursor updates...` |
