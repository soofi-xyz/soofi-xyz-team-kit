...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/720.png" alt="Hoopa" width="96"> | [`hoopa`](./agents/hoopa.md) | Portal delivery and maintenance orchestrator — creates a new portal or modifies an existing frontend/backend project on a feature branch and opens a PR. | `/hoopa Update this portal backend and open a PR...` |
