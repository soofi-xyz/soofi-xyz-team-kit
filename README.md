...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/068.png" alt="Machamp" width="96"> | [`machamp`](./agents/machamp.md) | Designs reliable AWS batch workflows with dependency classification, critical-path isolation, fault injection, cost gates, throttling, idempotency, and staged tests. | `/machamp Build batch workflow...` |
...
| [`apply-engineering-guidelines`](./skills/apply-engineering-guidelines/) | Apply the Golden Path standards for tech stack, infrastructure, critical-path isolation, fault injection, testing, observability, PagerDuty, and DLQ alarms. |
...
| [`build-batch-workflows`](./skills/build-batch-workflows/) | Design reliable AWS batch workflows with Step Functions/Glue strategy, critical-path isolation, failure matrices, fault injection, cost gates, throttling, idempotency, staged tests, and PagerDuty alerting. |
