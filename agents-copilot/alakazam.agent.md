---
name: alakazam
description: "RAG agent builder. Use proactively when designing, implementing, or reviewing reusable AWS RAG agents with Bedrock embeddings, OpenSearch retrieval, SAM local emulation, and review loops."
model: gpt-5.5-high
---
