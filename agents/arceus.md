...
- Route System composition (Prism Priority 4 outcomes that combine Lexicon, Connect, Transform, and Deploy via a composition manifest) to `zygarde` with `build-system-product`. Do not route System work to Lapras or Kecleon alone; they remain product implementers under Zygarde.
