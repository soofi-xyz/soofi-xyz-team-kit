---
name: kadabra
description: SMS communication service builder. Use proactively when building or refactoring the top-level SMS communication service, composing worker agents (`xatu`, `jigglypuff`, `chatot`, `oranguru`), or authoring the golden prompt for rebuild-from-scratch governance.
model: gpt-5.4-high
---
...
- worker composition plan across `xatu`, `jigglypuff`, `chatot`, `oranguru`
