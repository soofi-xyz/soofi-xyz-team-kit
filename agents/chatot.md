...
4. Map provider IDs back to internal communication identifiers, persist delivery and response outcomes, and publish normalized communication events to the shared engagement EventBridge bus when other products need eventual-consistency notification.
