...
description: "Implement or change the Account service from its PRD — customer identity, API keys, AWS sub-account provisioning, DNS, bootstrap manifest. Read reference/PRD.md first."
