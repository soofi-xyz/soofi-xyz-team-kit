...
description: "Prototyping local retrieval (RAG) tools that agents can query from the terminal — corpus evaluation, search quality, machine-readable output, and usage instructions."
---
