...
description: "Manage SMS and email channel templates in Git-backed inventories — CRUD, metadata normalization, family/variant structure, and sync from operational stores to GitHub."
---
